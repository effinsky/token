...
local function treesitter(p)
  return {
    ...
    -- Markup (markdown etc.)
    ['@markup'] = { fg = p.fg0 },
    ['@markup.strong'] = { italic = true },
    ['@markup.italic'] = { italic = true },
    ['@markup.strikethrough'] = { strikethrough = true },
    ['@markup.underline'] = { underline = true },
    ['@markup.heading'] = { fg = p.accent, italic = true },
    ['@markup.heading.1'] = { fg = p.accent, italic = true },
    ['@markup.heading.2'] = { fg = p.accent2, italic = true },
    ['@markup.heading.3'] = { fg = p.olive, italic = true },
    ['@markup.heading.4'] = { fg = p.blue, italic = true },
    ['@markup.heading.5'] = { fg = p.green, italic = true },
    ['@markup.heading.6'] = { fg = p.purple, italic = true },
